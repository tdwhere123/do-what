...
## 10. 文档重建执行（2026-02-28 / docs-rebuild）

本轮仅做文档重建，不改代码实现：

- 统一根文档与模块 README 为 do-what 叙事。
- 明确两条启动链路：
  - 默认业务链路：`pnpm dev`
  - 桌面链路：`pnpm run dev:desktop`
- 新增安装/启动/排错/模块说明/运行时矩阵文档：
  - `docs/INSTALL_WINDOWS.md`
  - `docs/STARTUP_GUIDE.md`
  - `docs/TROUBLESHOOTING.md`
  - `docs/CORE_LOGIC_AND_MODULES.md`
  - `docs/RUNTIME_MATRIX.md`
- 强调 `opencode-router` 为可选能力，不阻塞 v0.6 主链路。
- 新增执行记录：`plans/execution/04-docs-rebuild.md`。
