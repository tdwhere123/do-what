 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, do-what) are NOT translated
 */
...
export default {
  ...
  "dashboard.hero_description": "Describe an outcome. do-what will run it and keep an audit trail.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Save an do-what server as a worker.",
  "dashboard.create_remote_workspace_confirm": "Add Worker",
  "dashboard.edit_remote_workspace_title": "Edit Remote Connection",
  "dashboard.edit_remote_workspace_subtitle": "Update the do-what server details for this worker.",
  "dashboard.edit_remote_workspace_confirm": "Save connection",
  "dashboard.remote_workspace_title": "Remote worker",
  "dashboard.remote_workspace_hint": "Track an do-what server and reconnect anytime.",
  "dashboard.remote_base_url_label": "do-what server URL",
  "dashboard.remote_base_url_placeholder": "http://127.0.0.1:8787",
  "dashboard.remote_base_url_required": "Add a server URL to continue.",
  "dashboard.openwork_host_label": "do-what server URL",
  "dashboard.openwork_host_placeholder": "https://your-server.openwork.app",
  "dashboard.openwork_host_hint": "Use the URL shared by your do-what server.",
  ...
  "dashboard.remote_mode_openwork_alpha": "do-what server",
  "dashboard.remote_mode_direct": "Direct (legacy)",
  "dashboard.remote_connection_openwork": "do-what",
  ...
  "session.placeholder": "Ask do-what...",
  "session.run": "Run",
  ...
  "skills.host_only_error": "Skill management requires a local worker or connected do-what server.",
  ...
  "skills.connect_host_to_load": "Connect an do-what server to load skills.",
  ...
  // ==================== Apps (MCP) ====================
  "mcp.apps_title": "Apps",
  "mcp.apps_subtitle": "Connect your favorite tools so do-what can use them on your behalf.",
  ...
  "mcp.mcps_title": "Apps",
  "mcp.connect_mcp_hint": "Connect apps to expand what do-what can do.",
  ...
  "mcp.mcps_label": "Apps",
  "mcp.mcps_description": "Connect apps to expand what do-what can do.",
  ...
  "mcp.auth.step2_title": "Authorize do-what",
  ...
  "settings.updates_description": "Keep do-what up to date.",
  ...
  "settings.advanced_description": "Reset do-what local state to retest onboarding.",
  "settings.reset_onboarding": "Reset onboarding",
  "settings.reset_onboarding_description": "Clears do-what preferences and restarts the app.",
  "settings.reset_app_data": "Reset app data",
  "settings.reset_app_data_description": "More aggressive. Clears do-what cache + app data.",
  ...
  "settings.reset_confirmation_hint": "Type <span class=\"font-mono\">RESET</span> to confirm. do-what will restart.",
  "settings.reset_onboarding_warning": "Clears do-what local preferences and worker onboarding markers.",
  "settings.reset_app_data_warning": "Clears do-what cache and app data on this device.",
  ...
  "settings.updates_hint": "Keep do-what up to date.",
  ...
  "settings.advanced_hint": "Reset do-what local state to retest onboarding.",
  "settings.reset_onboarding_label": "Reset onboarding",
  "settings.reset_onboarding_hint": "Clears do-what preferences and restarts the app.",
  "settings.reset_app_data_label": "Reset app data",
  "settings.reset_app_data_hint": "More aggressive. Clears do-what cache + app data.",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "Starting do-what server...",
  "onboarding.searching_host": "Connecting to do-what server...",
  ...
  "onboarding.start": "Start do-what",
  ...
  "onboarding.windows_install_instruction": "Install OpenCode for Windows, then restart do-what. Ensure opencode.exe is on PATH.",
  ...
  "onboarding.cli_install_commands": "Install OpenCode with one of the commands below, then restart do-what.",
  ...
  "onboarding.remote_workspace_title": "Connect to do-what server",
  "onboarding.remote_workspace_description": "Connect to an do-what server to access a worker from anywhere.",
  "onboarding.remote_workspace_action": "Connect",
  "onboarding.remote_workspace_card_title": "Connect a remote worker",
  "onboarding.remote_workspace_card_description": "Connect to an do-what server to access a shared worker.",
  "onboarding.advanced_openwork_host": "do-what server",
  ...
  "onboarding.welcome_title": "How would you like to run do-what today?",
  "onboarding.run_local": "Run locally",
  "onboarding.run_local_description": "do-what runs OpenCode locally and keeps your work private.",
  ...
  "onboarding.default_workspace_path": "~/do-what/Worker",
  ...
  "app.migration.restart_failed": "Migration completed, but do-what could not restart the local engine.",
