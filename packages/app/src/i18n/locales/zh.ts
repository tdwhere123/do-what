/**
 * 中文（简体）翻译
 * 专业术语不翻译：Skills、Plugins、Commands、Sessions、OpenCode、OpenPackage、do-what、MCPs
 */
...
export default {
  ...
  "dashboard.hero_description": "描述一个目标。do-what 将运行它并保留审计记录。",
  ...
  "dashboard.remote_mode_openwork_alpha": "do-what 服务器",
  ...
  "session.placeholder": "向 do-what 提问...",
  "session.run": "运行",
  ...
  "skills.host_only_error": "技能管理需要本地工作区或已连接的 do-what 服务器。",
  ...
  "skills.connect_host_to_load": "连接 do-what 服务器以加载技能。",
  ...
  "mcp.mcps_title": "MCPs",
  "mcp.connect_mcp_hint": "连接 MCP 服务器以扩展 do-what 的功能。",
  ...
  "mcp.mcps_label": "MCPs",
  "mcp.mcps_description": "连接 MCP 服务器以扩展 do-what 的功能。",
  "mcp.configured": "已配置",
  "mcp.updated": "更新时间",
  ...
  "mcp.auth.step2_title": "授权 do-what",
  ...
  "settings.done": "完成",
  "settings.updates": "更新",
  "settings.updates_description": "保持 do-what 为最新版本。",
  ...
  "settings.advanced_description": "重置 do-what 本地状态以重新测试入门流程。",
  ...
  "settings.reset_confirmation_hint": "输入 <span class=\"font-mono\">RESET</span> 以确认。do-what 将重启。",
  "settings.reset_onboarding_warning": "清除 do-what 本地偏好设置和工作区入门标记。",
  "settings.reset_app_data_warning": "清除此设备上的 do-what 缓存和应用数据。",
  ...
  "settings.updates_hint": "保持 do-what 为最新版本。",
  ...
  "settings.advanced_hint": "重置 do-what 本地状态以重新测试入门流程。",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "正在启动 do-what 服务器...",
  "onboarding.searching_host": "正在连接 do-what 服务器...",
  ...
  "onboarding.windows_install_instruction": "安装 Windows 版 OpenCode，然后重启 do-what。确保 opencode.exe 在 PATH 中。",
  ...
  "onboarding.cli_install_commands": "使用以下命令之一安装 OpenCode，然后重启 do-what。",
  ...
  "onboarding.remote_workspace_title": "连接 do-what 服务器",
  "onboarding.remote_workspace_description": "连接 do-what 服务器以随时访问工作区。",
  "onboarding.remote_workspace_action": "连接",
  "onboarding.remote_workspace_card_title": "连接远程工作区",
  "onboarding.remote_workspace_card_description": "连接 do-what 服务器以访问共享工作区。",
  "onboarding.advanced_openwork_host": "do-what 服务器",
  ...
  "onboarding.welcome_title": "今天想如何运行 do-what？",
  "onboarding.run_local": "本地运行",
  "onboarding.run_local_description": "do-what 在本地运行 OpenCode 并保持您的工作私密。",
  ...
  "onboarding.default_workspace_path": "~/do-what/Workspace",
  ...
  "app.migration.restart_failed": "迁移已完成，但 do-what 无法重启本地引擎。",
