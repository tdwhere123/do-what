---
name: browser-setup
description: Guide the user through browser automation setup in do-what
---

Help the user set up browser automation in do-what.
...
1) Are you using the do-what desktop app, or the web app?
...
2) If they want the OpenCode Browser path:
   - Tell them where to check in do-what (Plugins tab) and what "connected" looks like.
